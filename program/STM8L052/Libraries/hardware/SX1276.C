...
uint8 SX1276LoRaSetOpMode( RFMode_SET opMode )
{
    uint8_t opModePrev;
...
static void Init_LORA_SPI()
{
    ...
    SX1276.DIO0.port = GPIOC;
    GPIO_Init(SX1276.DIO0.port, SX1276.DIO0.pin, GPIO_Mode_In_FL_IT);
    EXTI_SetPinSensitivity(EXTI_Pin_1,EXTI_Trigger_Rising);
    
    SX1276.DIO1.pin = GPIO_Pin_4;
    SX1276.DIO1.port = GPIOC;
    GPIO_Init(SX1276.DIO1.port, SX1276.DIO1.pin, GPIO_Mode_In_FL_IT);
    EXTI_SetPinSensitivity(EXTI_Pin_4,EXTI_Trigger_Rising);
    
    SX1276.Reset.pin = GPIO_Pin_0;
    SX1276.Reset.port = GPIOC;
    SX1276.Reset.set=Set_Reset;
    SX1276.Reset.reset = Reset_Reset;
    GPIO_Init(SX1276.Reset.port,SX1276.Reset.pin,GPIO_Mode_Out_PP_Low_Fast); 
    
    SX1276.NSS.pin = GPIO_Pin_4;
    SX1276.NSS.port = GPIOB;
    SX1276.NSS.set=Set_NSS;
    ...
    SX1276.MISO.get = Get_MISO;
    GPIO_Init(SX1276.MISO.port,SX1276.MISO.pin,GPIO_Mode_In_FL_No_IT);
    
    SX1276.SCK.pin = GPIO_Pin_5;
    SX1276.SCK.port = GPIOB;
    SX1276.SCK.set=Set_SCK;
    SX1276.SCK.reset = Reset_SCK;
    GPIO_Init(SX1276.SCK.port,SX1276.SCK.pin,GPIO_Mode_Out_PP_Low_Fast); 
    
    SX1276.RxTx.pin = GPIO_Pin_3;
...
void SX1276SetPower(int8_t power,uint8 PA_enable)
{
    uint8_t paConfig = 0;
    uint8_t paDac = 0;
...
//unfinished
static uint8 SX1276OptimalChannel()
{
    uint8 channel = 0;
...
void Init_Radio()
{
    ...
    SX1276.Settings.Address = getPHYAddress();
}