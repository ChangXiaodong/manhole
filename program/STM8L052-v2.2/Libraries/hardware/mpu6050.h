...
#define MPU_SDA_PORT     GPIOD
#define MPU_SDA_BIT      GPIO_Pin_1
#define MPU_SDA_HIGH     GPIO_SetBits(MPU_SDA_PORT,MPU_SDA_BIT);
#define MPU_SDA_LOW      GPIO_ResetBits(MPU_SDA_PORT,MPU_SDA_BIT);

#define MPU_SCL_PORT     GPIOD
#define MPU_SCL_BIT      GPIO_Pin_0
