...
{
    SX1276.DIO0.pin = GPIO_Pin_5;
    SX1276.DIO0.port = GPIOD;
    GPIO_Init(SX1276.DIO0.port, SX1276.DIO0.pin, GPIO_Mode_In_FL_IT);
    EXTI_SetPinSensitivity(EXTI_Pin_5,EXTI_Trigger_Rising);
    
    SX1276.DIO1.pin = GPIO_Pin_6;
    SX1276.DIO1.port = GPIOD;
    
    SX1276.Reset.pin = GPIO_Pin_4;
    SX1276.Reset.port = GPIOD;
